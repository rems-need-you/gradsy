...
<body>
  <main class="container">
    <div class="card">
      ...
      <p class="muted">Integrated grading, extracurricular, and discipline trackin are manage students, enter grades per quarter, compute averages, and generate printable reports. Designed for simplicity and fast data entry while keeping integrity of grade calculations and school records.</p>
      ...
      <div class="grid">
        <div class="feature">
          ...
          <p class="muted">Store student details, grade level, section, and historical averages.</p>
        </div>
        <div class="feature">
        ...
        <div class="feature">
          <h3>Reports & Print</h3>
          <p class="muted">Printable grade reports</p>
        </div>
      </div>
      ...
      <footer>
        © <span id="year"></span> LAC — Learning Area Chair. All rights reserved.
      </footer>
    </div>
  </main>
